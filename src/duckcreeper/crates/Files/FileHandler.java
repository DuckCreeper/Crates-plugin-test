...
public class FileHandler {
	...
	public void loadFiles() {
		crateLootFile = new File("plugins/Crates/Crate/crate loot.yml");
		crateLootConfig = YamlConfiguration.loadConfiguration(crateLootFile);
		
		cratesFile = new File("plugins/Crates/Crate/crates.yml");
		cratesConfig = YamlConfiguration.loadConfiguration(cratesFile);

		keysFile = new File("plugins/Crates/Crate/keys.yml");
		keysConfig = YamlConfiguration.loadConfiguration(keysFile);
		
		virtualKeysFile = new File("plugins/Crates/Crate/virtual keys.yml");
		virtualKeysConfig = YamlConfiguration.loadConfiguration(virtualKeysFile);
		
		dataFile = new File("plugins/Crates/Dont edit/data.yml");
		dataConfig = YamlConfiguration.loadConfiguration(dataFile);
		
		locationsFile = new File("plugins/Crates/Dont edit/locations.yml");
		locationsConfig = YamlConfiguration.loadConfiguration(locationsFile);
		
		mobDropsFile = new File("plugins/Crates/Drops/mob drops.yml");
		mobDropsConfig = YamlConfiguration.loadConfiguration(mobDropsFile);
		
		blockDropsFile = new File("plugins/Crates/Drops/block drops.yml");
		blockDropsConfig = YamlConfiguration.loadConfiguration(blockDropsFile);
		
		languageFile = new File("plugins/Crates/Extra/language.yml");
		languageConfig = YamlConfiguration.loadConfiguration(languageFile);
		
		permissionsFile = new File("plugins/Crates/Extra/permissions.yml");
		permissionsConfig = YamlConfiguration.loadConfiguration(permissionsFile);
		
		playerLogFile = new File("plugins/Crates/Logs/player_log.yml");
		playerLogConfig = YamlConfiguration.loadConfiguration(playerLogFile);
		
		prizeLogFile = new File("plugins/Crates/Logs/prize_log.yml");
		prizeLogConfig = YamlConfiguration.loadConfiguration(prizeLogFile);
		
		customGUIFile = new File("plugins/Crates/Crate/custom GUI.yml");
		customGUIConfig = YamlConfiguration.loadConfiguration(customGUIFile);

		virtualCratesFile = new File("plugins/Crates/Crate/virtual crates.yml");
		virtualCratesConfig = YamlConfiguration.loadConfiguration(virtualCratesFile);
		
		voucherFile = new File("plugins/Crates/logs/voucher data.yml");
